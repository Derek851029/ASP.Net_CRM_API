<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2016111602.aspx.cs" Inherits="Update" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="" style="width: 1024px; margin: 10px 20px">
            ...
            <tbody>
                <tr>
                    <th>
                        <div style="float: left; font-size: 20px"> 2. 【系統參數維護】新增【醫療院所管理】</div>
                    </th>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    <th>
                        <img src="211.png" id="update_image" onclick="A()" style="float: left; width: 1024px;" />
                    </th>
                </tr>
            </tbody>
        </table>
